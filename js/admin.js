...
function renderCustomers(customers) {
    ...
    attachCustomerRowEventListeners();
}

function attachCustomerRowEventListeners() {
...
// SEARCH FUNCTIONS WITH BUTTON SUPPORT
function filterCustomers() {
    ...
    console.log('Total customers to search:', allCustomers.length);
    ...
    const filtered = allCustomers.filter(customer => {
        ...
        const matches = nameMatch || emailMatch || itemsMatch || statusMatch || pointsMatch || phoneMatch;
        
        if (matches) {
            console.log('Found match:', customer.name);
        }
...
function setupEventListeners() {
    ...
    // SEARCH BUTTONS - NEW FUNCTIONALITY
    ...
    if (clearSearchBtn) {
        clearSearchBtn.addEventListener('click', function(e) {
            ...
            console.log('Clear search clicked, showing all customers');
            renderCustomers(allCustomers);
        });
    }
    
    // Customer profiles search buttons
    const customerSearchBtn = document.getElementById('customer-search-btn');
    const clearCustomerSearchBtn = document.getElementById('clear-customer-search-btn');
    ...
    if (clearCustomerSearchBtn) {
        clearCustomerSearchBtn.addEventListener('click', function(e) {
            e.preventDefault();
